...
def fig_convnet_conv_only():
    _pipeline(
        ...
        [
            ...
            dict(kind="vol", s=37, c=10, shape="37×37×10", name="CONV1", role="conv"),
            dict(kind="vol", s=17, c=20, shape="17×17×20", name="CONV2", role="conv"),
            dict(kind="vol", s=7, c=40, shape="7×7×40", name="CONV3", role="conv"),
            dict(kind="vec", u=1960, shape="1,960", name="flatten", role="flat"),
            dict(kind="vec", u=1, shape="ŷ", name="logistic", role="out"),
        ],
        [
            "10 filters 3×3\ns=1, p=0",
            "20 filters 5×5\ns=2, p=0",
...
def fig_convnet_lenet_style():
    _pipeline(
        ...
        [
            ...
            dict(kind="vec", u=10, shape="10", name="softmax", role="out"),
        ],
        [
            "6 filters 5×5\ns=1, p=0",
            "max pool\nf=2, s=2",
