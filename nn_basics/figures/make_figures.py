...
def fig_lenet5():
    pipeline(
        ...
        [
            ...
            dict(kind="vol", s=28, c=6, shape="28×28×6", name="CONV1", role="conv"),
            dict(kind="vol", s=14, c=6, shape="14×14×6", name="POOL1", role="pool"),
            dict(kind="vol", s=10, c=16, shape="10×10×16", name="CONV2", role="conv"),
            dict(kind="vol", s=5, c=16, shape="5×5×16", name="POOL2", role="pool"),
            dict(kind="vec", u=400, shape="400", name="flatten", role="flat"),
            dict(kind="vec", u=120, shape="120", name="FC3", role="fc"),
            dict(kind="vec", u=84, shape="84", name="FC4", role="fc"),
...
def fig_alexnet():
    pipeline(
        ...
        [
            ...
            dict(kind="vol", s=55, c=96, shape="55×55×96", name="CONV 11×11 s=4", role="conv"),
            dict(kind="vol", s=27, c=96, shape="27×27×96", name="POOL", role="pool"),
            dict(kind="vol", s=27, c=256, shape="27×27×256", name="CONV 5×5 same", role="conv"),
            dict(kind="vol", s=13, c=256, shape="13×13×256", name="POOL", role="pool"),
            dict(kind="vol", s=13, c=384, shape="13×13×384", name="CONV 3×3 ×2", role="conv"),
            dict(kind="vol", s=13, c=256, shape="13×13×256", name="CONV 3×3", role="conv"),
            dict(kind="vol", s=6, c=256, shape="6×6×256", name="POOL", role="pool"),
            dict(kind="vec", u=9216, shape="9216", name="flatten", role="flat"),
            dict(kind="vec", u=4096, shape="4096", name="FC ×2", role="fc"),
            dict(kind="vec", u=1000, shape="1000", name="softmax", role="out"),
        ],
        [
            "96 filters\n11×11, s=4",
            "max pool\nf=3, s=2",
...
def fig_vgg16():
    pipeline(
        ...
        [
            ...
            dict(kind="vol", s=224, c=64, shape="224×224×64", name="CONV 64 ×2", role="conv"),
            dict(kind="vol", s=112, c=128, shape="112×112×128", name="CONV 128 ×2", role="conv"),
            dict(kind="vol", s=56, c=256, shape="56×56×256", name="CONV 256 ×3", role="conv"),
            dict(kind="vol", s=28, c=512, shape="28×28×512", name="CONV 512 ×3", role="conv"),
            dict(kind="vol", s=14, c=512, shape="14×14×512", name="CONV 512 ×3", role="conv"),
